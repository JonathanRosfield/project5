...
<div class="flex justify-center gap-4 p-8">
    ...
    <button v-for="page in pages" :key="page" :class="[ 'rounded-md p-2 font-medium shadow-md', page === activePage ? 'bg-blue-500 text-slate-100' : 'bg-slate-100 text-slate-700 hover:bg-slate-300']">{{ page }}</button>
